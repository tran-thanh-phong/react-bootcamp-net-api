...
function CartSummary() {
  ...
  const handleQuantity = (
    ...
    dispatch(updateQuantity({ cartItem, quantity: updateQuantityBy }));
  };
  ...
  return (
    <div className="container p-4 m-2">
      ...
      {cartItems.map((item: cartItemModel, index: number) => (
        <div
          key={index}
          className="d-flex flex-sm-row flex-column align-items-center custom-card-shadow rounded m-3"
          style={{ background: "ghostwhite" }}
        >
          ...
          <div className="p-2 mx-3 w-100">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <h4 className="">
                {((item.quantity ?? 0) * (item.menuItem?.price ?? 0)).toFixed(
                  2
                )}
              </h4>
            </div>
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div
                className="d-flex justify-content-between align-items-center p-2 mt-2 rounded-pill custom-card-shadow"
